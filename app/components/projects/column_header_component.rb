...
class Projects::ColumnHeaderComponent < ApplicationComponent # rubocop:disable OpenProject/AddPreviewForViewComponent
  ...
  def sort_link(column)
    ...
    link_to(helpers.safe_query_params(projects_query_param_names_for_sort).merge(sortBy: JSON::dump(orders[0..2])),
  ...
  def projects_query_param_names_for_sort = ProjectsHelper::PROJECTS_QUERY_PARAM_NAMES - %i[sortBy page]
end
